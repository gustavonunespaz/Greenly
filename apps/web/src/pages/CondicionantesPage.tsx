...
import { Clock, Upload, ClipboardList, Filter } from "lucide-react";
                ...
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="flex flex-col items-end gap-2 shrink-0">
                    ...
                    {c.status !== "CUMPRIDA" && c.status !== "DISPENSADA" && (
                      <button className="mt-1 px-3 py-1.5 rounded-xl bg-white/[0.03] border border-white/[0.06] text-xs text-muted-foreground/60 hover:text-primary hover:bg-primary/5 hover:border-primary/20 transition-all duration-200 flex items-center gap-1.5">
